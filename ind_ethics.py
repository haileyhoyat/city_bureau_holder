...
class IndEthicsSpider(CityScrapersSpider):
    name = "ind_ethics"
    agency = "Indianapolis Ethics Committee"
    timezone = "America/Chicago"
    start_urls = ["https://calendar.indy.gov/event/ethics-committee-meeting/"]
    ...
    def parse(self, response):
        ...
        driver.get(
            "https://calendar.indy.gov/event/ethics-committee-meeting/"  # noqa
        )
        time.sleep(10)
        try:
