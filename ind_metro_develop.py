...
class IndMetroDevelopSpider(CityScrapersSpider):
    name = "ind_metro_develop"
    agency = "Indianapolis Metropolitan Development Commission"
    timezone = "America/Chicago"
    start_urls = [
        "https://calendar.indy.gov/event/metropolitan-development-commission-29/"
    ]
    ...
    def parse(self, response):
        ...
        driver.get(
            "https://calendar.indy.gov/event/metropolitan-development-commission-29/"  # noqa
        )
        time.sleep(10)
        try:
