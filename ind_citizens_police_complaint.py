...
class IndCitizensPoliceComplaintSpider(CityScrapersSpider):
    ...
    def parse(self, response):
        ...
        yield SeleniumRequest(
            ...
            wait_time=10,
            wait_until=EC.presence_of_element_located((By.CSS_SELECTOR, ".collapsible div:nth-child(2) dd")))
    ...
    def parse_result(self, response):
        ...
        try:
            ...
            element = driver.find_element(By.CSS_SELECTOR, ".collapsible div:nth-child(2) dd")
            print("found element")
    ...
    def _parse_time_notes(self, item):
        ...
        return "Please double check the meeting notice for the meeting time and location."
    ...
    def _parse_links(self, item):
        ...
        return [{"href": meeting_notice, "title": "Meeting Notice"},
