...
class IndPublicWorksSpider(CityScrapersSpider):
    name = "ind_public_works"
    agency = "Indianapolis Public Works Committee"
    timezone = "America/Chicago"
    start_urls = ["https://calendar.indy.gov/event/public-works-committee-meeting-13/"]
    ...
    def parse(self, response):
        ...
        driver.get(
            "https://calendar.indy.gov/event/public-works-committee-meeting-13/"  # noqa
        )
        time.sleep(10)
        try:
    ...
    def _parse_title(self, item):
        ...
        return "Public Works Committee Meeting"
