...
class IndPublicSafetyCjSpider(CityScrapersSpider):
    name = "ind_public_safety_cj"
    agency = "Indianapolis Public Safety and Criminal Justice Committee"
    timezone = "America/Chicago"
    start_urls = ["https://calendar.indy.gov/event/public-safety--criminal-justice-committee-meeting/"]
    ...
    def parse(self, response):
        ...
        driver.get(
            "https://calendar.indy.gov/event/public-safety--criminal-justice-committee-meeting/"  # noqa
        )
        time.sleep(10)
        try:
    ...
    def _parse_title(self, item):
        ...
        return "Public Safety & Criminal Justice Committee"
