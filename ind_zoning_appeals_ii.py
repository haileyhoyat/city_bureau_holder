...
class IndZoningAppealsIiSpider(CityScrapersSpider):
    name = "ind_zoning_appeals_ii"
    agency = "Indianapolis Zoning Appeals II"
    timezone = "America/Chicago"
    start_urls = [
        "https://calendar.indy.gov/event/board-of-zoning-appeals-division-ii-11/"
    ]
    ...
    def parse(self, response):
        ...
        driver.get(
            "https://calendar.indy.gov/event/board-of-zoning-appeals-division-ii-11/"  # noqa
        )
        time.sleep(10)
        try:
    ...
    def _parse_title(self, item):
        ...
        return "Board of Zoning Appeals (BZA) Division II"

    def _parse_description(self, item):
        """Parse or generate meeting description."""
        return "Division II hears petitions from Center, Decatur, Pike, and Washington Townships."  # noqa
