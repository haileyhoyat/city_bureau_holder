...
class IndCityCouncilSpider(CityScrapersSpider):
    name = "ind_city_council"
    agency = "Indianapolis City Council"
    timezone = "America/Chicago"
    start_urls = ["https://calendar.indy.gov/event/full-city-county-council-meeting-14/"]
    ...
    def parse(self, response):
        ...
        driver.get(
            "https://calendar.indy.gov/event/full-city-county-council-meeting-14/"  # noqa
        )
        time.sleep(10)
        try:
