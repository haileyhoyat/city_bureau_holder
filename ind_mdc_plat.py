...
class IndMdcPlatSpider(CityScrapersSpider):
    name = "ind_mdc_plat"
    agency = "Indianapolis MDC Plat Committee"
    timezone = "America/Chicago"
    start_urls = ["https://calendar.indy.gov/event/mdc-plat-committee/"]

    def parse(self, response):
        print("inside parse_result")
        meeting_list = []
        driver = webdriver.Chrome()
        driver.get("https://calendar.indy.gov/event/mdc-plat-committee/")  # noqa
        time.sleep(10)
        try:
            ...
            if "Meeting Room 260" in location_html:
                location = {
