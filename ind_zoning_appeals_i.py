...
class IndZoningAppealsISpider(CityScrapersSpider):
    name = "ind_zoning_appeals_i"
    agency = "Indianapolis Zoning Appeals I"
    timezone = "America/Chicago"
    start_urls = ["https://calendar.indy.gov/event/board-of-zoning-appeals-division-i/"]
    ...
    def parse(self, response):
        ...
        driver.get(
            "https://calendar.indy.gov/event/board-of-zoning-appeals-division-i/"  # noqa
        )
        time.sleep(10)
        try:
    ...
    def _parse_title(self, item):
        ...
        return "Board of Zoning Appeals (BZA) Division I"

    def _parse_description(self, item):
        """Parse or generate meeting description."""
        return "Division I hears petitions from Center, Franklin, Pike, Washington, & Wayne Townships."  # noqa
