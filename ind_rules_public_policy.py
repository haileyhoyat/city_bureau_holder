...
class IndRulesPublicPolicySpider(CityScrapersSpider):
    name = "ind_rules_public_policy"
    agency = "Indianapolis Rules and Public Policy Committee"
    timezone = "America/Chicago"
    start_urls = ["https://calendar.indy.gov/event/rules-and-public-policy-committee-meeting/"]
    ...
    def parse(self, response):
        ...
        driver.get(
            "https://calendar.indy.gov/event/rules-and-public-policy-committee-meeting/"  # noqa
        )
        time.sleep(10)
        try:
    ...
    def _parse_title(self, item):
        ...
        return "Rules and Public Policy Committee"
